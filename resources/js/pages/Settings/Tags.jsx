                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <Button type="submit" disabled={processing} className="bg-[var(--accent-blue)] hover:opacity-90 text-white shadow-sm border-0 ml-2">
                                        Save
                                    </Button>
                                </div>
                                ...
                                {editingId === tag.id ? (
                                    <form onSubmit={(e) => handleUpdate(e, tag.id)} className="flex-1 flex gap-4 items-end">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <Button type="submit" disabled={processing} className="bg-[var(--accent-blue)] text-white hover:opacity-90">Save</Button>
                                        </div>
                                    </form>
                                ) : (
                                    <>
