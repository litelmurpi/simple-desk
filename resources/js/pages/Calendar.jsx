                ...
                <div className={cn(
                    ...
                    <div className="flex items-center justify-between mb-[var(--space-6)]">
                        ...
                        <Link href={route('tickets.create')}>
                            <Button className="bg-[var(--accent-blue)] text-white hover:opacity-90 shadow-sm transition-colors">
                                                ...
                                                {day && (
                                                    <div className="flex items-start justify-between">
                                                        <span className={cn(
                                                            ...
                                                            isToday 
                                                                ? "bg-[var(--accent-blue)] text-white shadow-lg shadow-[var(--accent-blue-soft)] font-semibold" 
                                                                : isWeekend ? "text-[var(--text-tertiary)]" : "text-[var(--text-primary)]"
                                                        )}>
                                                            {day}
                                                        </span>
                                                        {dayTickets.length > 0 && (
                                                            <span className="text-[10px] text-[var(--accent-blue)] font-semibold bg-[var(--accent-blue-soft)] px-1.5 py-0.5 rounded-[var(--radius-sm)] border border-[var(--accent-blue)]/20">
