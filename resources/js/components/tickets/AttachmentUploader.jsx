                ...
                {data.file ? (
                    <div className="flex flex-col items-center gap-3">
                        ...
                        <button 
                            ...
                            disabled={processing}
                            className="bg-[var(--accent-blue)] text-white text-sm font-medium py-1.5 px-4 rounded-[var(--radius-md)] flex items-center gap-2 hover:opacity-90 transition-colors disabled:opacity-70"
                        >
